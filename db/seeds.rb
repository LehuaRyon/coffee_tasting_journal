...
User.find_or_create_by(username: "H_Brown", email: "harrybrown@gmail.com", password: "password", first_name: "Harry", last_name: "Brown")
User.find_or_create_by(username: "L_Smith", email: "leonasmith@gmail.com", password: "password", first_name: "Leona", last_name: "Smith")
User.find_or_create_by(username: "O_King", email: "owenking@gmail.com", password: "password", first_name: "Owen", last_name: "King")
User.find_or_create_by(username: "S_Lacey", email: "sofialacey@gmail.com", password: "password", first_name: "Sofia", last_name: "Lacey")
User.find_or_create_by(username: "J_Scott", email: "janscott@gmail.com", password: "password", first_name: "Jan", last_name: "Scott")
